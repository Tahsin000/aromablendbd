...
@section('title', 'Add Review | Organic Tea Admin')

@section('content')
<div class="container-fluid">
    <div class="page-title-head d-flex align-items-center mb-3">
        <div class="flex-grow-1">
            <h4 class="page-main-title m-0">Add Review</h4>
        </div>
        <div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.ecommerce.review-store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted">JPEG, PNG, JPG, WEBP - max 200KB</small>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="ti ti-check me-1"></i> Save Review
                    </button>
