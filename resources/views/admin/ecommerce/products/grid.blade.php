                    ...
                    <div class="d-flex flex-wrap justify align-items-center gap-3">
                        <div class="d-lg-none d-flex gap-2">
                            <button class="btn btn-default btn-icon" type="button" data-bs-toggle="offcanvas"
                                data-bs-target="#productFillterOffcanvas" aria-controls="productFillterOffcanvas">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-3 border-bottom border-dashed">
                                <div class="d-flex mb-2 justify-content-between align-items-center">
                                    ...
                                    <a href="javascript: void(0);" class="btn btn-link btn-sm px-0 fw-semibold">View
                                        All</a>
                                </div>
                ...
                <div class="row row-cols-xxl-4 row-cols-lg-3 row-cols-sm-2 row-col-1 g-2">
                    <div class="col">
                        <article class="card h-100 mb-2">
                            <!-- Badge -->
                            <div
                                class="badge text-bg-success badge-label fs-base rounded position-absolute top-0 start-0 m-3">
                                15% OFF</div>
                            ...
                            <div class="card-body pb-0">
                                ...
                                <h6 class="card-title fs-sm lh-base mb-2">
                                    <a href="apps-ecommerce-product-details.html" class="link-reset">Modern Minimalist
                                        Fabric Sofa Single Seater</a>
                                </h6>
                                ...
                                <div>
                                    ...
                                    <span class="ms-1">
                                        <a href="apps-ecommerce-reviews.html" class="link-reset fw-semibold">(45)</a>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="col">
                        <article class="card h-100 mb-2">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <!-- Title -->
                                <h6 class="card-title fs-sm lh-base mb-2">
                                    <a href="apps-ecommerce-product-details.html" class="link-reset">Funky Streetwear
                                ...
                                <div>
                                    ...
                                    <span class="ms-1">
                                        <a href="apps-ecommerce-reviews.html" class="link-reset fw-semibold">(32)</a>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="col">
                        <article class="card h-100 mb-2">
                            <!-- Badge -->
                            <div
                                class="badge text-bg-danger badge-label fs-base rounded position-absolute top-0 start-0 m-3">
                                15% OFF</div>
                            ...
                            <div class="card-body pb-0">
                                ...
                                <!-- Title -->
                                <h6 class="card-title fs-sm lh-base mb-2">
                                    <a href="apps-ecommerce-product-details.html" class="link-reset">Noise Canceling
                                ...
                                <div>
                                    ...
                                    <span class="ms-1">
                                        <a href="apps-ecommerce-reviews.html" class="link-reset fw-semibold">(58)</a>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="col">
                        <article class="card h-100 mb-2">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <!-- Title -->
                                <h6 class="card-title fs-sm lh-base mb-2">
                                    <a href="apps-ecommerce-product-details.html" class="link-reset">Minimalist Solid Wood
                                        Dining Chair</a>
                                </h6>
                                ...
                                <div>
                                    ...
                                    <span class="ms-1">
                                        <a href="apps-ecommerce-reviews.html" class="link-reset fw-semibold">(46)</a>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="col">
                        <article class="card h-100 mb-2">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <!-- Title -->
                                <h6 class="card-title fs-sm lh-base mb-2">
                                    <a href="apps-ecommerce-product-details.html" class="link-reset">Modern Black
                                        Minimalist Wall Clock</a>
                                </h6>
                                ...
                                <div>
                                    ...
                                    <span class="ms-1">
                                        <a href="apps-ecommerce-reviews.html" class="link-reset fw-semibold">(62)</a>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="col">
                        <article class="card h-100 mb-2">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <!-- Title -->
                                <h6 class="card-title fs-sm lh-base mb-2">
                                    <a href="apps-ecommerce-product-details.html" class="link-reset">Elegant Brown Wooden
                                        Chair</a>
                                </h6>
                                ...
                                <div>
                                    ...
                                    <span class="ms-1">
                                        <a href="apps-ecommerce-reviews.html" class="link-reset fw-semibold">(48)</a>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="col">
                        <article class="card h-100 mb-2">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <!-- Title -->
                                <h6 class="card-title fs-sm lh-base mb-2">
                                    <a href="apps-ecommerce-product-details.html" class="link-reset">Apple iMac 24" Retina
                                        4.5K Display</a>
                                </h6>
                                ...
                                <div>
                                    ...
                                    <span class="ms-1">
                                        <a href="apps-ecommerce-reviews.html" class="link-reset fw-semibold">(65)</a>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="col">
                        <article class="card h-100 mb-2">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <!-- Title -->
                                <h6 class="card-title fs-sm lh-base mb-2">
                                    <a href="apps-ecommerce-product-details.html" class="link-reset">Coolest Ergonomic
                                        Lounge Chair</a>
                                </h6>
                                ...
                                <div>
                                    ...
                                    <span class="ms-1">
                                        <a href="apps-ecommerce-reviews.html" class="link-reset fw-semibold">(52)</a>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="col">
                        <article class="card h-100 mb-2">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <!-- Title -->
                                <h6 class="card-title fs-sm lh-base mb-2">
                                    <a href="apps-ecommerce-product-details.html" class="link-reset">Apple iPad 10.9"
                                        Wi-Fi 64GB - Silver</a>
                                </h6>
                                ...
                                <div>
                                    ...
                                    <span class="ms-1">
                                        <a href="apps-ecommerce-reviews.html" class="link-reset fw-semibold">(142)</a>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="col">
                        <article class="card h-100 mb-2">
                            <div class="card-body pb-0">
                                <div class="p-3">
                                    <img src="assets/images/products/10.png" alt="minimal-jacket" class="img-fluid" />
                                </div>
                                <h6 class="card-title fs-sm lh-base mb-2">
                                    <a href="apps-ecommerce-product-details.html" class="link-reset">Minimalist Denim
                                        Jacket – Indigo Blue</a>
                                </h6>
                                <div>
                                    <span class="text-warning">
                                        <i class="ti ti-star-filled"></i>
                                    ...
                                    <span class="ms-1">
                                        <a href="apps-ecommerce-reviews.html" class="link-reset fw-semibold">(54)</a>
                                    </span>
                                </div>
                            </div>
                            <div class="card-footer bg-transparent d-flex justify-content-between">
                    ...
                    <div class="col">
                        <article class="card h-100 mb-2">
                            <div class="card-body pb-0">
                                <div class="p-3">
                                    <img src="assets/images/products/1.png" alt="smartwatch" class="img-fluid" />
                                </div>
                                <h6 class="card-title fs-sm lh-base mb-2">
                                    <a href="apps-ecommerce-product-details.html" class="link-reset">Next-Gen Smartwatch
                                        S9 – Graphite Black</a>
                                </h6>
                                <div>
                                    <span class="text-warning">
                                    ...
                                    <span class="ms-1">
                                        <a href="apps-ecommerce-reviews.html" class="link-reset fw-semibold">(128)</a>
                                    </span>
                                </div>
                            </div>
                            <div class="card-footer bg-transparent d-flex justify-content-between">
                    ...
                    <div class="col">
                        <article class="card h-100 mb-2">
                            <div class="card-body pb-0">
                                <div class="p-3">
                                    <img src="assets/images/products/2.png" alt="headphones" class="img-fluid" />
                                </div>
                                <h6 class="card-title fs-sm lh-base mb-2">
                                    <a href="apps-ecommerce-product-details.html" class="link-reset">Noise-Cancel Pro
                                        Headphones – Arctic White</a>
                                </h6>
                                <div>
                                    <span class="text-warning">
                                        <i class="ti ti-star-filled"></i>
                                    ...
                                    <span class="ms-1">
                                        <a href="apps-ecommerce-reviews.html" class="link-reset fw-semibold">(87)</a>
                                    </span>
                                </div>
                            </div>
                            <div class="card-footer bg-transparent d-flex justify-content-between">
